...
<div id="captcha-<?= $captcha->id ?>" class="vulcan-captcha">
    ...
    <input type="<?= $captcha->type == $captcha::TYPE_MATHEMATICAL ? 'number' : 'text' ?>" required name="_captcha-<?= $captcha->id ?>-input" placeholder="<?= $captcha->type == $captcha::TYPE_MATHEMATICAL ? 'Result ?' : 'Enter Captcha' ?>">
